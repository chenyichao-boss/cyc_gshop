<template>
    ...
    <a href="javascript:;" class="guide_item" :class ="{on:'/msite'=== $route.path }" @click="() => {this.$router.replace('/msite')}">
      <span class="item_icon">
        <i class="iconfont icon-waimai"></i>
      </span>
      <span>外卖</span>
    </a>
    <a href="javascript:;" class="guide_item" :class ="{on:'/search'===$route.path }" @click="searchButton">
      <span class="item_icon">
